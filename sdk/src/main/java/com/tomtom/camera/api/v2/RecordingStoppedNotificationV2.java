...
/**
 * Concrete implementation of interface {@link RecordingStoppedNotification}
 */
class RecordingStoppedNotificationV2 implements RecordingStoppedNotification {

    @SerializedName("recording_stopped")
    private ArrayList<VideoV2> mVideos;

    public RecordingStoppedNotificationV2() {

    }

    @Override
    public BackchannelNotificationType getNotificationType() {
        return BackchannelNotificationType.RECORDING_STOPPED;
    }
