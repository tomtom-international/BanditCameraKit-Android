...
/**
 * This interface correspondents to event from camera : wifi stopped  and
 * defines function that provides access to that information
 */
public interface WifiStoppedNotification extends BackchannelNotification {
    /**
     * Returns false since wifi is stopped
     * @return false
     */
