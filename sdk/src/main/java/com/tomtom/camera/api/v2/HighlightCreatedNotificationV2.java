...
/**
 * Concrete implementation of interface {@link HighlightCreatedNotification}
 */
class HighlightCreatedNotificationV2 implements HighlightCreatedNotification {

    @SerializedName("tag_created")
    private HighlightV2 mTagCreated;
