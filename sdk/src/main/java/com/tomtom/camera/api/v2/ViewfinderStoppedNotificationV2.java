...
import com.tomtom.camera.api.notification.model.ViewfinderStoppedNotification;

/**
 * Concrete implementation of interface {@link ViewfinderStoppedNotification}
 */
class ViewfinderStoppedNotificationV2 implements ViewfinderStoppedNotification {

    @SerializedName("viewfinder_stopped")
    private ViewfinderActive mViewfinderActive;

    @Override
    public BackchannelNotificationType getNotificationType() {
        return BackchannelNotificationType.VIEWFINDER_STOPPED;
    }
