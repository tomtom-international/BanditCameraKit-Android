...
/**
 * Concrete implementation of interface {@link RecordingStatus}
 */
class RecordingStatusV2 implements RecordingStatus {
    @SerializedName("recording_active")
    boolean mRecordingActive;

    public RecordingStatusV2(boolean recordingActive) {
